// ╔══════════════════════════════════════════════════════════════════╗
// ║   Modern ES6-ES2024 Features  →  13_structuredclone.js
// ║   Level: Junior → Google/Apple Senior
// ╚══════════════════════════════════════════════════════════════════╝
//
// TARGET:
//   Crack interview questions around: structuredClone()
//
...
//
// structuredClone():
// structuredClone deep-clones supported structured data.
//
...
//
// Runtime rule:
//   handles Date, Map, Set, arrays, objects, and cycles better than JSON
//
// Practical rule:
//   Use it when you need a real clone of supported data.
//
// Common trap:
//   Trying to clone functions or DOM nodes.
//
...
// Predict the output.
// Then run:
//   node "learning/phase-1-javascript/section-1.3-js-advanced-concepts/07_modern-es6-es2024-features/13_structuredclone.js"
...
function predictionDrill() {
  ...
  steps.push("1. Identify topic: structuredClone()");
  steps.push("2. Apply rule: handles Date, Map, Set, arrays, objects, and cycles better than JSON");
  steps.push("3. Avoid trap: Trying to clone functions or DOM nodes.");
...
//
// Interview framing:
//   "I care about structuredClone() because it appears in real code when
...
function bugChecklist() {
  return {
    bug: "Trying to clone functions or DOM nodes.",
    rule: "handles Date, Map, Set, arrays, objects, and cycles better than JSON",
    fix: "Use it when you need a real clone of supported data.",
  };
}
...
// ══════════════════════════════════════════════════════════════════
//
// When asked about "structuredClone()", answer like this:
//
//   "At a high level, structuredClone deep-clones supported structured data.
//    The important runtime rule is: handles Date, Map, Set, arrays, objects, and cycles better than JSON
//    A common trap is: Trying to clone functions or DOM nodes.
...
// A1. structuredClone deep-clones supported structured data.
//
// Q2. What is the runtime rule?
// A2. handles Date, Map, Set, arrays, objects, and cycles better than JSON
//
// Q3. What bug does this cause in real projects?
// A3. Trying to clone functions or DOM nodes.
//
// Q4. How do you avoid the bug?
// A4. Use it when you need a real clone of supported data.
//
...
//   Back : structuredClone deep-clones supported structured data.
//
// Flashcard 2:
//   Front: What is the runtime rule?
//   Back : handles Date, Map, Set, arrays, objects, and cycles better than JSON
//
// Flashcard 3:
//   Front: What is the most common trap?
//   Back : Trying to clone functions or DOM nodes.
//
// Flashcard 4:
...
//
// For "structuredClone()", practice these levels:
//
// Level 1 — Definition:
//   structuredClone deep-clones supported structured data.
//
...
//    In this case, the rule is: handles Date, Map, Set, arrays, objects, and cycles better than JSON
//    That is why the common bug happens: Trying to clone functions or DOM nodes."
//
...
//
// Practice prompt:
//   "Here is a code snippet using structuredClone(). Predict the output and
...
//   3. The exact rule: handles Date, Map, Set, arrays, objects, and cycles better than JSON
//   4. The output or state change.
//   5. The bug risk: Trying to clone functions or DOM nodes.
//
...
//   Use it when you need a real clone of supported data.
//
// NEXT TOPIC -> 14_top-level-await.js
