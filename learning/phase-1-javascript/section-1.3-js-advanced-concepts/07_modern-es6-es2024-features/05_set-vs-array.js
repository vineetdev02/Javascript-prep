// ╔══════════════════════════════════════════════════════════════════╗
// ║   Modern ES6-ES2024 Features  →  05_set-vs-array.js
// ║   Level: Junior → Google/Apple Senior
// ╚══════════════════════════════════════════════════════════════════╝
//
// TARGET:
//   Crack interview questions around: Set vs Array
//
...
//
// Set vs Array:
// Set stores unique values and gives quick membership checks.
//
...
//
// Runtime rule:
//   Set removes duplicates and supports `.has()`
//
// Practical rule:
//   Use Set for uniqueness, Array for indexed ordered operations.
//
// Common trap:
//   Using Set when duplicates/order-by-index are required.
//
...
// Predict the output.
// Then run:
//   node "learning/phase-1-javascript/section-1.3-js-advanced-concepts/07_modern-es6-es2024-features/05_set-vs-array.js"
...
function predictionDrill() {
  ...
  steps.push("1. Identify topic: Set vs Array");
  steps.push("2. Apply rule: Set removes duplicates and supports `.has()`");
  steps.push("3. Avoid trap: Using Set when duplicates/order-by-index are required.");
...
//
// Interview framing:
//   "I care about Set vs Array because it appears in real code when
...
function bugChecklist() {
  return {
    bug: "Using Set when duplicates/order-by-index are required.",
    rule: "Set removes duplicates and supports `.has()`",
    fix: "Use Set for uniqueness, Array for indexed ordered operations.",
  };
}
...
// ══════════════════════════════════════════════════════════════════
//
// When asked about "Set vs Array", answer like this:
//
//   "At a high level, Set stores unique values and gives quick membership checks.
//    The important runtime rule is: Set removes duplicates and supports `.has()`
//    A common trap is: Using Set when duplicates/order-by-index are required.
...
// A1. Set stores unique values and gives quick membership checks.
//
// Q2. What is the runtime rule?
// A2. Set removes duplicates and supports `.has()`
//
// Q3. What bug does this cause in real projects?
// A3. Using Set when duplicates/order-by-index are required.
//
// Q4. How do you avoid the bug?
// A4. Use Set for uniqueness, Array for indexed ordered operations.
//
...
//
// Flashcard 1:
//   Front: What is Set vs Array?
//   Back : Set stores unique values and gives quick membership checks.
//
// Flashcard 2:
//   Front: What is the runtime rule?
//   Back : Set removes duplicates and supports `.has()`
//
// Flashcard 3:
//   Front: What is the most common trap?
//   Back : Using Set when duplicates/order-by-index are required.
//
// Flashcard 4:
...
//
// For "Set vs Array", practice these levels:
//
// Level 1 — Definition:
//   Set stores unique values and gives quick membership checks.
//
...
//    In this case, the rule is: Set removes duplicates and supports `.has()`
//    That is why the common bug happens: Using Set when duplicates/order-by-index are required."
//
...
//
// Practice prompt:
//   "Here is a code snippet using Set vs Array. Predict the output and
...
//   3. The exact rule: Set removes duplicates and supports `.has()`
//   4. The output or state change.
//   5. The bug risk: Using Set when duplicates/order-by-index are required.
//
...
//   Use Set for uniqueness, Array for indexed ordered operations.
//
// NEXT TOPIC -> 06_generators-iterators.js
