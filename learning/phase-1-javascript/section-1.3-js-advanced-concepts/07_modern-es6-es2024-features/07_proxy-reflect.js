// ╔══════════════════════════════════════════════════════════════════╗
// ║   Modern ES6-ES2024 Features  →  07_proxy-reflect.js
// ║   Level: Junior → Google/Apple Senior
// ╚══════════════════════════════════════════════════════════════════╝
//
// TARGET:
//   Crack interview questions around: Proxy & Reflect
//
...
//
// Proxy & Reflect:
// Proxy intercepts object operations; Reflect performs default operations.
//
...
//
// Runtime rule:
//   get/set/has/delete can be trapped
//
// Practical rule:
//   Use Reflect inside traps to preserve default semantics.
//
// Common trap:
//   Breaking object invariants in proxy traps.
//
...
// Predict the output.
// Then run:
//   node "learning/phase-1-javascript/section-1.3-js-advanced-concepts/07_modern-es6-es2024-features/07_proxy-reflect.js"
...
function predictionDrill() {
  ...
  steps.push("1. Identify topic: Proxy & Reflect");
  steps.push("2. Apply rule: get/set/has/delete can be trapped");
  steps.push("3. Avoid trap: Breaking object invariants in proxy traps.");
...
//
// Interview framing:
//   "I care about Proxy & Reflect because it appears in real code when
...
function bugChecklist() {
  return {
    bug: "Breaking object invariants in proxy traps.",
    rule: "get/set/has/delete can be trapped",
    fix: "Use Reflect inside traps to preserve default semantics.",
  };
}
...
// ══════════════════════════════════════════════════════════════════
//
// When asked about "Proxy & Reflect", answer like this:
//
//   "At a high level, Proxy intercepts object operations; Reflect performs default operations.
//    The important runtime rule is: get/set/has/delete can be trapped
//    A common trap is: Breaking object invariants in proxy traps.
...
// A1. Proxy intercepts object operations; Reflect performs default operations.
//
// Q2. What is the runtime rule?
// A2. get/set/has/delete can be trapped
//
// Q3. What bug does this cause in real projects?
// A3. Breaking object invariants in proxy traps.
//
// Q4. How do you avoid the bug?
// A4. Use Reflect inside traps to preserve default semantics.
//
...
//
// Flashcard 1:
//   Front: What is Proxy & Reflect?
//   Back : Proxy intercepts object operations; Reflect performs default operations.
//
// Flashcard 2:
//   Front: What is the runtime rule?
//   Back : get/set/has/delete can be trapped
//
// Flashcard 3:
//   Front: What is the most common trap?
//   Back : Breaking object invariants in proxy traps.
//
// Flashcard 4:
...
//
// For "Proxy & Reflect", practice these levels:
//
// Level 1 — Definition:
//   Proxy intercepts object operations; Reflect performs default operations.
//
...
//    In this case, the rule is: get/set/has/delete can be trapped
//    That is why the common bug happens: Breaking object invariants in proxy traps."
//
...
//
// Practice prompt:
//   "Here is a code snippet using Proxy & Reflect. Predict the output and
...
//   3. The exact rule: get/set/has/delete can be trapped
//   4. The output or state change.
//   5. The bug risk: Breaking object invariants in proxy traps.
//
...
//   Use Reflect inside traps to preserve default semantics.
//
// NEXT TOPIC -> 08_optional-chaining.js
