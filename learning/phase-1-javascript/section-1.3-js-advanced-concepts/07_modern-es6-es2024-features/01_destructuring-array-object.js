// ╔══════════════════════════════════════════════════════════════════╗
// ║   Modern ES6-ES2024 Features  →  01_destructuring-array-object.js
// ║   Level: Junior → Google/Apple Senior
// ╚══════════════════════════════════════════════════════════════════╝
//
// TARGET:
//   Crack interview questions around: Destructuring (array & object)
//
...
// Destructuring extracts values from arrays and objects by pattern.
//
...
//
// Runtime rule:
//   defaults, aliases, nested extraction, and rest are supported
//
// Practical rule:
//   Use defaults for optional nested data.
//
// Common trap:
//   Destructuring nested properties from undefined.
//
...
// Predict the output.
// Then run:
//   node "learning/phase-1-javascript/section-1.3-js-advanced-concepts/07_modern-es6-es2024-features/01_destructuring-array-object.js"
...
const featureReport = {
  topic: "Destructuring (array & object)",
  supported: true,
...
function predictionDrill() {
  ...
  steps.push("1. Identify topic: Destructuring (array & object)");
  steps.push("2. Apply rule: defaults, aliases, nested extraction, and rest are supported");
  steps.push("3. Avoid trap: Destructuring nested properties from undefined.");
...
//
// Interview framing:
//   "I care about Destructuring (array & object) because it appears in real code when
...
function bugChecklist() {
  return {
    bug: "Destructuring nested properties from undefined.",
    rule: "defaults, aliases, nested extraction, and rest are supported",
    fix: "Use defaults for optional nested data.",
  };
}
...
// ══════════════════════════════════════════════════════════════════
//
// When asked about "Destructuring (array & object)", answer like this:
//
//   "At a high level, Destructuring extracts values from arrays and objects by pattern.
//    The important runtime rule is: defaults, aliases, nested extraction, and rest are supported
//    A common trap is: Destructuring nested properties from undefined.
...
// A1. Destructuring extracts values from arrays and objects by pattern.
//
// Q2. What is the runtime rule?
// A2. defaults, aliases, nested extraction, and rest are supported
//
// Q3. What bug does this cause in real projects?
// A3. Destructuring nested properties from undefined.
//
// Q4. How do you avoid the bug?
// A4. Use defaults for optional nested data.
//
...
//
// Flashcard 1:
//   Front: What is Destructuring (array & object)?
//   Back : Destructuring extracts values from arrays and objects by pattern.
//
// Flashcard 2:
//   Front: What is the runtime rule?
//   Back : defaults, aliases, nested extraction, and rest are supported
//
// Flashcard 3:
//   Front: What is the most common trap?
//   Back : Destructuring nested properties from undefined.
//
// Flashcard 4:
...
//
// For "Destructuring (array & object)", practice these levels:
//
// Level 1 — Definition:
//   Destructuring extracts values from arrays and objects by pattern.
//
...
//    In this case, the rule is: defaults, aliases, nested extraction, and rest are supported
//    That is why the common bug happens: Destructuring nested properties from undefined."
//
...
//
// Practice prompt:
//   "Here is a code snippet using Destructuring (array & object). Predict the output and
...
//   3. The exact rule: defaults, aliases, nested extraction, and rest are supported
//   4. The output or state change.
//   5. The bug risk: Destructuring nested properties from undefined.
//
...
//   Use defaults for optional nested data.
//
// NEXT TOPIC -> 02_template-literals.js
