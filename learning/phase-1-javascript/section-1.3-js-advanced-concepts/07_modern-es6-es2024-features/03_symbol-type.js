// ╔══════════════════════════════════════════════════════════════════╗
// ║   Modern ES6-ES2024 Features  →  03_symbol-type.js
// ║   Level: Junior → Google/Apple Senior
// ╚══════════════════════════════════════════════════════════════════╝
//
// TARGET:
//   Crack interview questions around: Symbol type
//
...
//
// Practical rule:
//   Use symbols for non-colliding keys and protocols.
//
// Common trap:
//   Expecting symbols in Object.keys.
//
...
// Predict the output.
// Then run:
//   node "learning/phase-1-javascript/section-1.3-js-advanced-concepts/07_modern-es6-es2024-features/03_symbol-type.js"
...
function predictionDrill() {
  ...
  steps.push("1. Identify topic: Symbol type");
  steps.push("2. Apply rule: Symbol('id') !== Symbol('id')");
  steps.push("3. Avoid trap: Expecting symbols in Object.keys.");
...
//
// Interview framing:
//   "I care about Symbol type because it appears in real code when
...
function bugChecklist() {
  return {
    bug: "Expecting symbols in Object.keys.",
    rule: "Symbol('id') !== Symbol('id')",
    fix: "Use symbols for non-colliding keys and protocols.",
  };
}
...
// ══════════════════════════════════════════════════════════════════
//
// When asked about "Symbol type", answer like this:
//
//   "At a high level, Symbols create unique property keys.
//    The important runtime rule is: Symbol('id') !== Symbol('id')
//    A common trap is: Expecting symbols in Object.keys.
...
// A1. Symbols create unique property keys.
//
// Q2. What is the runtime rule?
// A2. Symbol('id') !== Symbol('id')
//
// Q3. What bug does this cause in real projects?
// A3. Expecting symbols in Object.keys.
//
// Q4. How do you avoid the bug?
// A4. Use symbols for non-colliding keys and protocols.
//
...
//
// Flashcard 1:
//   Front: What is Symbol type?
//   Back : Symbols create unique property keys.
//
// Flashcard 2:
//   Front: What is the runtime rule?
//   Back : Symbol('id') !== Symbol('id')
//
// Flashcard 3:
//   Front: What is the most common trap?
//   Back : Expecting symbols in Object.keys.
//
// Flashcard 4:
...
//
// For "Symbol type", practice these levels:
//
// Level 1 — Definition:
//   Symbols create unique property keys.
//
...
//    In this case, the rule is: Symbol('id') !== Symbol('id')
//    That is why the common bug happens: Expecting symbols in Object.keys."
//
...
//
// Practice prompt:
//   "Here is a code snippet using Symbol type. Predict the output and
...
//   3. The exact rule: Symbol('id') !== Symbol('id')
//   4. The output or state change.
//   5. The bug risk: Expecting symbols in Object.keys.
//
...
//   Use symbols for non-colliding keys and protocols.
//
// NEXT TOPIC -> 04_map-vs-object.js
