// ╔══════════════════════════════════════════════════════════════════╗
// ║   Modern ES6-ES2024 Features  →  04_map-vs-object.js
// ║   Level: Junior → Google/Apple Senior
// ╚══════════════════════════════════════════════════════════════════╝
//
// TARGET:
//   Crack interview questions around: Map vs Object
//
...
//
// Map vs Object:
// Map is designed for dynamic key-value collections.
//
...
//
// Runtime rule:
//   Map accepts any key type and has `.size`
//
// Practical rule:
//   Prefer Map when keys are not fixed object property names.
//
// Common trap:
//   Using objects as unsafe dictionaries with user-controlled keys.
//
...
// Predict the output.
// Then run:
//   node "learning/phase-1-javascript/section-1.3-js-advanced-concepts/07_modern-es6-es2024-features/04_map-vs-object.js"
...
function predictionDrill() {
  ...
  steps.push("1. Identify topic: Map vs Object");
  steps.push("2. Apply rule: Map accepts any key type and has `.size`");
  steps.push("3. Avoid trap: Using objects as unsafe dictionaries with user-controlled keys.");
...
//
// Interview framing:
//   "I care about Map vs Object because it appears in real code when
...
function bugChecklist() {
  return {
    bug: "Using objects as unsafe dictionaries with user-controlled keys.",
    rule: "Map accepts any key type and has `.size`",
    fix: "Prefer Map when keys are not fixed object property names.",
  };
}
...
// ══════════════════════════════════════════════════════════════════
//
// When asked about "Map vs Object", answer like this:
//
//   "At a high level, Map is designed for dynamic key-value collections.
//    The important runtime rule is: Map accepts any key type and has `.size`
//    A common trap is: Using objects as unsafe dictionaries with user-controlled keys.
...
// A1. Map is designed for dynamic key-value collections.
//
// Q2. What is the runtime rule?
// A2. Map accepts any key type and has `.size`
//
// Q3. What bug does this cause in real projects?
// A3. Using objects as unsafe dictionaries with user-controlled keys.
//
// Q4. How do you avoid the bug?
// A4. Prefer Map when keys are not fixed object property names.
//
...
//
// Flashcard 1:
//   Front: What is Map vs Object?
//   Back : Map is designed for dynamic key-value collections.
//
// Flashcard 2:
//   Front: What is the runtime rule?
//   Back : Map accepts any key type and has `.size`
//
// Flashcard 3:
//   Front: What is the most common trap?
//   Back : Using objects as unsafe dictionaries with user-controlled keys.
//
// Flashcard 4:
...
//
// For "Map vs Object", practice these levels:
//
// Level 1 — Definition:
//   Map is designed for dynamic key-value collections.
//
...
//    In this case, the rule is: Map accepts any key type and has `.size`
//    That is why the common bug happens: Using objects as unsafe dictionaries with user-controlled keys."
//
...
//
// Practice prompt:
//   "Here is a code snippet using Map vs Object. Predict the output and
...
//   3. The exact rule: Map accepts any key type and has `.size`
//   4. The output or state change.
//   5. The bug risk: Using objects as unsafe dictionaries with user-controlled keys.
//
