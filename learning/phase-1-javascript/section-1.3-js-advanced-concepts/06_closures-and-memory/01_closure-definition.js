// ╔══════════════════════════════════════════════════════════════════╗
// ║   Closures & Memory  →  01_closure-definition.js
// ║   Level: Junior → Google/Apple Senior
// ╚══════════════════════════════════════════════════════════════════╝
//
// TARGET:
//   Crack interview questions around: Closure definition
//
...
//
// Runtime rule:
//   inner function remembers outer variables after outer returns
//
// Practical rule:
//   Say: function plus remembered scope, not just private variables.
//
// Common trap:
//   Defining closure only as privacy.
//
...
// Predict the output.
// Then run:
//   node "learning/phase-1-javascript/section-1.3-js-advanced-concepts/06_closures-and-memory/01_closure-definition.js"
...
const notebook = createInterviewNotebook("Closure definition");
...
function predictionDrill() {
  ...
  steps.push("1. Identify topic: Closure definition");
  steps.push("2. Apply rule: inner function remembers outer variables after outer returns");
  steps.push("3. Avoid trap: Defining closure only as privacy.");
...
//
// Interview framing:
//   "I care about Closure definition because it appears in real code when
...
function bugChecklist() {
  return {
    bug: "Defining closure only as privacy.",
    rule: "inner function remembers outer variables after outer returns",
    fix: "Say: function plus remembered scope, not just private variables.",
  };
}
...
// ══════════════════════════════════════════════════════════════════
//
// When asked about "Closure definition", answer like this:
//
//   "At a high level, A closure is a function bundled with its lexical environment.
//    The important runtime rule is: inner function remembers outer variables after outer returns
//    A common trap is: Defining closure only as privacy.
...
// A1. A closure is a function bundled with its lexical environment.
//
// Q2. What is the runtime rule?
// A2. inner function remembers outer variables after outer returns
//
// Q3. What bug does this cause in real projects?
// A3. Defining closure only as privacy.
//
// Q4. How do you avoid the bug?
// A4. Say: function plus remembered scope, not just private variables.
//
...
//
// Flashcard 1:
//   Front: What is Closure definition?
//   Back : A closure is a function bundled with its lexical environment.
//
// Flashcard 2:
//   Front: What is the runtime rule?
//   Back : inner function remembers outer variables after outer returns
//
// Flashcard 3:
//   Front: What is the most common trap?
//   Back : Defining closure only as privacy.
//
// Flashcard 4:
...
//
// For "Closure definition", practice these levels:
//
// Level 1 — Definition:
//   A closure is a function bundled with its lexical environment.
//
...
//    In this case, the rule is: inner function remembers outer variables after outer returns
//    That is why the common bug happens: Defining closure only as privacy."
//
...
//
// Practice prompt:
//   "Here is a code snippet using Closure definition. Predict the output and
...
//   3. The exact rule: inner function remembers outer variables after outer returns
//   4. The output or state change.
//   5. The bug risk: Defining closure only as privacy.
//
...
//   Say: function plus remembered scope, not just private variables.
//
// NEXT TOPIC -> 02_practical-closure-examples.js
