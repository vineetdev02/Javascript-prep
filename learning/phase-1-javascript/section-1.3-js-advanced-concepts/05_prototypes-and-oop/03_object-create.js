// ╔══════════════════════════════════════════════════════════════════╗
// ║   Prototypes & OOP  →  03_object-create.js
// ║   Level: Junior → Google/Apple Senior
// ╚══════════════════════════════════════════════════════════════════╝
//
// TARGET:
//   Crack interview questions around: Object.create()
//
...
//
// Object.create():
// Object.create makes a new object with a specific prototype.
//
...
//
// Runtime rule:
//   it links to the prototype; it does not copy properties
//
// Practical rule:
//   Use it to demonstrate pure prototypal inheritance.
//
// Common trap:
//   Expecting Object.create to clone the source object.
//
...
// Predict the output.
// Then run:
//   node "learning/phase-1-javascript/section-1.3-js-advanced-concepts/05_prototypes-and-oop/03_object-create.js"
...
Engineer.prototype.describe = function() {
  return this.name + " understands Object.create()";
};
...
class SeniorEngineer extends Engineer {
  review() {
    return this.name + " can explain delegation object in interviews";
  }
}
...
function predictionDrill() {
  ...
  steps.push("1. Identify topic: Object.create()");
  steps.push("2. Apply rule: it links to the prototype; it does not copy properties");
  steps.push("3. Avoid trap: Expecting Object.create to clone the source object.");
...
//
// Interview framing:
//   "I care about Object.create() because it appears in real code when
...
function bugChecklist() {
  return {
    bug: "Expecting Object.create to clone the source object.",
    rule: "it links to the prototype; it does not copy properties",
    fix: "Use it to demonstrate pure prototypal inheritance.",
  };
}
...
// ══════════════════════════════════════════════════════════════════
//
// When asked about "Object.create()", answer like this:
//
//   "At a high level, Object.create makes a new object with a specific prototype.
//    The important runtime rule is: it links to the prototype; it does not copy properties
//    A common trap is: Expecting Object.create to clone the source object.
...
// A1. Object.create makes a new object with a specific prototype.
//
// Q2. What is the runtime rule?
// A2. it links to the prototype; it does not copy properties
//
// Q3. What bug does this cause in real projects?
// A3. Expecting Object.create to clone the source object.
//
// Q4. How do you avoid the bug?
// A4. Use it to demonstrate pure prototypal inheritance.
//
...
//
// Flashcard 1:
//   Front: What is Object.create()?
//   Back : Object.create makes a new object with a specific prototype.
//
// Flashcard 2:
//   Front: What is the runtime rule?
//   Back : it links to the prototype; it does not copy properties
//
// Flashcard 3:
//   Front: What is the most common trap?
//   Back : Expecting Object.create to clone the source object.
//
// Flashcard 4:
...
//
// For "Object.create()", practice these levels:
//
// Level 1 — Definition:
//   Object.create makes a new object with a specific prototype.
//
...
//    In this case, the rule is: it links to the prototype; it does not copy properties
//    That is why the common bug happens: Expecting Object.create to clone the source object."
//
...
//
// Practice prompt:
//   "Here is a code snippet using Object.create(). Predict the output and
...
//   3. The exact rule: it links to the prototype; it does not copy properties
//   4. The output or state change.
//   5. The bug risk: Expecting Object.create to clone the source object.
//
...
//   Use it to demonstrate pure prototypal inheritance.
//
// NEXT TOPIC -> 04_constructor-functions.js
