// ╔══════════════════════════════════════════════════════════════════╗
// ║   Prototypes & OOP  →  06_class-inheritance.js
// ║   Level: Junior → Google/Apple Senior
// ╚══════════════════════════════════════════════════════════════════╝
//
// TARGET:
//   Crack interview questions around: Class inheritance
//
...
//
// Class inheritance:
// Class inheritance links child prototypes to parent prototypes.
//
...
//
// Runtime rule:
//   child instances can use parent prototype methods
//
// Practical rule:
...
// Predict the output.
// Then run:
//   node "learning/05_prototypes-and-oop/06_class-inheritance.js"
...
Engineer.prototype.describe = function() {
  return this.name + " understands Class inheritance";
};
...
class SeniorEngineer extends Engineer {
  review() {
    return this.name + " can explain extends in interviews";
  }
}
...
function predictionDrill() {
  ...
  steps.push("1. Identify topic: Class inheritance");
  steps.push("2. Apply rule: child instances can use parent prototype methods");
  steps.push("3. Avoid trap: Using inheritance where composition would be simpler.");
...
//
// Interview framing:
//   "I care about Class inheritance because it appears in real code when
...
function bugChecklist() {
  return {
    bug: "Using inheritance where composition would be simpler.",
    rule: "child instances can use parent prototype methods",
    fix: "Use inheritance when there is a true is-a relationship.",
  };
}
...
// ══════════════════════════════════════════════════════════════════
//
// When asked about "Class inheritance", answer like this:
//
//   "At a high level, Class inheritance links child prototypes to parent prototypes.
//    The important runtime rule is: child instances can use parent prototype methods
//    A common trap is: Using inheritance where composition would be simpler.
...
// A1. Class inheritance links child prototypes to parent prototypes.
//
// Q2. What is the runtime rule?
// A2. child instances can use parent prototype methods
//
// Q3. What bug does this cause in real projects?
// A3. Using inheritance where composition would be simpler.
//
// Q4. How do you avoid the bug?
// A4. Use inheritance when there is a true is-a relationship.
//
...
//
// Flashcard 1:
//   Front: What is Class inheritance?
//   Back : Class inheritance links child prototypes to parent prototypes.
//
// Flashcard 2:
//   Front: What is the runtime rule?
//   Back : child instances can use parent prototype methods
//
// Flashcard 3:
//   Front: What is the most common trap?
//   Back : Using inheritance where composition would be simpler.
//
// Flashcard 4:
...
//
// For "Class inheritance", practice these levels:
//
// Level 1 — Definition:
//   Class inheritance links child prototypes to parent prototypes.
//
...
//    In this case, the rule is: child instances can use parent prototype methods
//    That is why the common bug happens: Using inheritance where composition would be simpler."
//
...
//
// Practice prompt:
//   "Here is a code snippet using Class inheritance. Predict the output and
...
//   3. The exact rule: child instances can use parent prototype methods
//   4. The output or state change.
//   5. The bug risk: Using inheritance where composition would be simpler.
//
...
//   Use inheritance when there is a true is-a relationship.
//
// NEXT TOPIC -> 07_super-keyword.js
